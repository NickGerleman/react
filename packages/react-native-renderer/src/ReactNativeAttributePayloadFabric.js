...
import type {AnyAttributeType, AttributeConfiguration} from './ReactNativeTypes';
...
function processProperty(prop: mixed, attributeConfig: AnyAttributeType): mixed {
  if (typeof attributeConfig !== 'object') {
    return prop;
  }
  ...
  return typeof attributeConfig.process === 'function'
    ? attributeConfig.process(prop)
    : prop;
}
...
function fastAddProperties(
  ...
  for (const propKey in props) {
    ...
    if (typeof prop === 'function') {
      ...
      newValue = processProperty(prop, ((attributeConfig: any): AnyAttributeType));
